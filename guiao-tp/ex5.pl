...
bprove(F,N) :- bprove(F,N,_).
bprove(F,N1,N2) :- N1>0, fact(F), N2 is N1-1.
bprove((A and B),N1,N3) :- bprove(A,N1,N2), bprove(B,N2,N3).
bprove((A or B),N1,N2) :- bprove(A,N1,N2); bprove(B,N1,N2).
bprove(G,N1,N2) :- if C then G, bprove(C,N1,N2).
